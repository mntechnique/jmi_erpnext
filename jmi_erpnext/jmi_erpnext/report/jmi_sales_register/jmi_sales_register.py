...
def _execute(filters, additional_table_columns=None, additional_query_columns=None):
	...
	columns, income_accounts, tax_accounts , against_accounts = get_columns(invoice_list, additional_table_columns, filters)
...
def get_gl_entries(filters,inv_name):
	gl_entries = frappe.db.sql(
		...
		and voucher_type IN ('Payment Entry' , 'Sales Invoice' , 'Journal Voucher')
		and against_voucher = '{inv_name}'
