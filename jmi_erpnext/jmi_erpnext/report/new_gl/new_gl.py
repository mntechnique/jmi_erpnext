...
def get_gl_entries(filters):
	...
	if filters.get('presentation_currency'):
		...
		# against_column = frappe.db.sql(
		# """select
		# 	voucher_type, voucher_no, cost_center, project,
		# 	against_voucher_type, against_voucher, against
		# from `tabGL Entry`
		# where voucher_type = "Sales Invoice" and against_voucher_type = "Sales Invoice" and company=%(company)s {conditions}
		# {group_by_condition}
		# order by posting_date, account"""

		# return against_column
